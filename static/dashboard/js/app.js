...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Chatwoot Config
  if (document.getElementById('chatwootConfig')) {
                  ...
                  <div class="column">
                      ...
                      <div class="ui list">
                          ...
                          <div class="item">
                              ...
                              <div class="content">${instance.chatwoot_config ? 'Configured' : 'No'}</div>
                          </div>
                          <div class="item">
...
async function deleteHmacConfig() {
  ...
  try {
    ...
    // Nova verifica├º├úo - estrutura direta sem "success"
    if (res.ok && response.Details) {
...
// --- CONFIGURA├ç├âO CHATWOOT (INTEGRA├ç├âO NATIVA) ---
