...
func (s *server) routes() {
	...
	// Chatwoot Webhook
	s.router.Handle("/chatwoot/webhook", c.Then(s.HandleChatwootWebhook())).Methods("POST")

	// Chatwoot Config API
	s.router.Handle("/chatwoot/config", c.Then(s.GetChatwootConfigHandler())).Methods("GET")
	s.router.Handle("/chatwoot/config", c.Then(s.SetChatwootConfigHandler())).Methods("POST")
